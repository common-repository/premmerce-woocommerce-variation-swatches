...
$premmerceTestimonials = [
    [
        'content' => __('Great, free, useful plugin if you want your category link to be yourURL/category name and product link to be yourURL/product-name. Even skips parent category names. Thank you so much!', 'premmerce-advanced-attributes'),
        'name'    => 'Riley Pearcy',
        'img'     => $riley_pearcy
    ],
    [
        'content' => __('THi All, We us this plugin for a big website we run. This plugin works with the famous WPML plugin. It’s removes the Product category base and the shop link in a Multilingual website. Must have for all WooCommerce users!!! Regards from a satisfied user.', 'premmerce-advanced-attributes'),
        'name'    => 'Lian Perry',
        'img'     => $lian_perry
    ],
    [
        'content' => __('The Premmerce Filter is BY FAR the best product filter plugin available for WordPress. It works well out of the box with a great layout. It’s something that you would think would be so simple, but finding a great product filter tool sure wasn’t easy. Really love how well it integrates with the Premmerce Brands plugin as well. Thanks!!', 'premmerce-advanced-attributes'),
        'name'    => 'Rommie Mercer',
        'img'     => $rommie_mercer
    ]
];
    ...
    <div class="c-section__container wow animated" style="visibility: visible;">
        <h2 class="c-section__title fade-up fade-up--step-1">
            <span style="font-weight: 400;">
                <?php _e('What clients say about Premmerce', 'premmerce-advanced-attributes'); ?>
            </span>
        </h2>
